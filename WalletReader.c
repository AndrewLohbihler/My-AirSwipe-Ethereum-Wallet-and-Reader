...
unsigned int Nsample,Msample,Rsample,Lsample,PAY,COLLECT;
...
//
    ...
    PORTA = 0b00000000;
    PORTC = 0b00001100;
    TRISA = 0b00001101;  //0 = Output, 1 = Input (RX is an input)
...
//    CCP1CON = 0b00001100; // duty lowest bits + PWM mode
    ...
    STR1C = 0;   // Start the PWM steering as off for LEFT_RF
